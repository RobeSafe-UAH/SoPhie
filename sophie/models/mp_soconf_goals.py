...
from sophie.modules.decoders import GoalMMDecoderLSTM
...
class TrajectoryGenerator(nn.Module):
    def __init__(
        ...
        self.decoder = GoalMMDecoderLSTM(h_dim=self.h_dim, n_samples=n_samples)
    ...
    def forward(self, obs_traj, obs_traj_rel, goal_points, start_end_seq, agent_idx=None):
        ...
        # decode trajectories
        pred_traj_fake_rel, conf = self.decoder(last_pos, last_pos_rel, state_tuple, goal_points)
