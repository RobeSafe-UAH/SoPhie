...
class TrajectoryGenerator(nn.Module):
    ...
    def forward(self, obs_traj, obs_traj_rel, start_end_seq, agent_idx=None):
        ...
        mlp_decoder_context_input = self.mlp_decoder_context(self.lnc(mlp_decoder_context_input)) # 80x24
        decoder_h = torch.unsqueeze(mlp_decoder_context_input, 0) # 1x80x32
